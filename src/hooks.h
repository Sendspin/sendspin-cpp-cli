...
struct HookContext {
    ...
    /// letting it describe whatever connects next, and it is exported only when the stream
    /// arrived from the server_id the dial chose. server_id always describes the connection
